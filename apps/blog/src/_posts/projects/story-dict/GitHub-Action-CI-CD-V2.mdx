...
## ⚙️ 환경 변수 설정
![02-GitHub_환경_변수_설정](/images/posts/projects/story-dict/GitHub-Action-CI-CD-V2/02-GitHub_환경_변수_설정.png)
...
### 1️⃣ 배포 알림
![03-슬랙_메시지_예시](/images/posts/projects/story-dict/GitHub-Action-CI-CD-V2/03-슬랙_메시지_예시.png)
...
![04-빌드_및_태그_설정_및_ECR_푸시](/images/posts/projects/story-dict/GitHub-Action-CI-CD-V2/04-빌드_및_태그_설정_및_ECR_푸시.png)
...
## 🎉 마무리
> [GitHub 코드](https://github.com/1-blue/story-dict/blob/master/.github/workflows/cicd.yaml)를 참고해주세요<br/>
